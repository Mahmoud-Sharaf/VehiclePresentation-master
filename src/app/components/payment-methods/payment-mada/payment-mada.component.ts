...
@Component({
  selector: 'app-payment-mada',
  templateUrl: './payment-mada.component.html',
  styleUrls: ['./payment-mada.component.css']
})
export class PaymentMadaComponent implements OnInit {
