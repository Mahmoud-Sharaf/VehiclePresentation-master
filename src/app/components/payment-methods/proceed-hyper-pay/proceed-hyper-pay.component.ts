...
@Component({
  selector: 'app-proceed-hyper-pay',
  templateUrl: './proceed-hyper-pay.component.html',
  styleUrls: ['./proceed-hyper-pay.component.css']
})
export class ProceedHyperPayComponent implements OnInit {
  ...
  constructor(public fb: FormBuilder, private http: HttpClient, private router: Router, private cdRef: ChangeDetectorRef,
  ...
  hyperpayResponseProcess(id) {
    const req = this.http.post(environment.checkout + "HyperpayProcessPayment?" + 'id=' + id 
